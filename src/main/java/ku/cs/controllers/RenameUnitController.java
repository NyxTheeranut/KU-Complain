...
public class RenameUnitController {
    ...
    public void handleCreateButton(){
        ...
        else if(Util.search(unitNameTextField.getText(),unitList.getAllUnits(), new UnitNameFilter()) != null){
        ...
        Util.search(u.getUnitName(),unitList.getAllUnits(),new UnitNameFilter()).setUnitName(unitNameTextField.getText());
