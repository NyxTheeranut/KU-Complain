...
public class MyComplaintController {
    ...
    public void initialize(){
        ...
        complaints = Data.filter(account.getId().toString(), dataSource.readData().getAllComplaints(), new ComplaintAuthorIdFilter());
...
//            vBox.setBorder(new Border(new BorderStroke(Color.BLACK,BorderStrokeStyle.SOLID, CornerRadii.EMPTY, BorderWidths.DEFAULT)));
    ...
    public void handleResetButton() {
        ((ObjectStorage) com.github.saacsos.FXRouter.getData()).getHomeController().loadPage("my_complaint.fxml");
    }
